...
import {
  Button, Header, Icon,
  Image, Label, Statistic, Message, Grid, Container, Segment, Loader, Radio, Dimmer
} from 'semantic-ui-react'

import { getSurvey, surveyPost } from '../api/survey-api'
  ...
  renderLoading() {
    return (
      <Segment >
        ...
        <Loader size='big' indeterminate active inline="centered">
